...
public class SymbolPairMatch3 {
    ...
    private SymbolPairMatch3 parent;

    public SymbolPairMatch3() {
        this(null);
    }

    public SymbolPairMatch3(SymbolPairMatch3 parent) {
        setParent(parent);
    }

    protected void setParent(SymbolPairMatch3 parent) {
        this.parent = parent;
    }
    ...
    public final static class DefaultSymbolPairs extends SymbolPairMatch3 {
